...
export class EventsModule extends PuterModule {
    onLocal: typeof onLocal;
    onPersistent: typeof onPersistent;
 ...
 * >} EventsConstructor
 */
export const Events: EventsConstructor;
 ...
 * accessor omitted.
 */
export type EventsConstructor = import("../../lib/types.js").OmitMembers<typeof EventsModule, "puter" | "authToken" | "channel">;
