export const MAX_THUMBNAIL_BYTES: number;
...
export const SIGNED_BATCH_WRITE_UNAVAILABLE_STATUSES: Set<number>;
export const SIGNED_BATCH_SUPPORTED_ENVS: string[];
export const SPACE_CHECK_MIN_BYTES: number;
